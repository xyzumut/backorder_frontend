...
const App = () => {
    ...
    const [ pageIndex, setPageIndex ] = React.useState( location.pathname === '/mail' ? 2 : ( location.pathname === '/internet' ? 3 : ( location.pathname === '/' || location.pathname === '/anasayfa' ? 1 : 4) ) );
    ...
    return (
        ...
        <Layout>
            ...
            <Routes>
                ...
                <Route path="/kayit/:domain"  element={ <DataPage/> } />
